...
namespace PicturePlotDB
{
    class SQLiteDB
    {
        ...
        public SQLiteConnection myDBConnection = new SQLiteConnection();
        ...
        public void ReadFromDB(string sqlQuery, ref SQLiteDataReader myReader, ref SQLiteTransaction myTransaction) 
        {
            status = String.Empty;
        ...
        public int AddRecord(string tableName, string columnsName, string values)
        {
            status = String.Empty;
            if (myDBConnection.State != ConnectionState.Open)
            {
            ...
            try
            {
                mySQLCommand.CommandText = "INSERT INTO " + tableName + " " + columnsName + " values " + values;
                status = status + mySQLCommand.CommandText;
